/*
  ...
  - Added the required column `exitRecordedById` to the `AccessLog` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_AccessLog" (
    ...
    "exitRecordedById" TEXT NOT NULL,
    ...
    CONSTRAINT "AccessLog_exitRecordedById_fkey" FOREIGN KEY ("exitRecordedById") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
INSERT INTO "new_AccessLog" ("companyNameSnapshot", "createdById", "entrySignatureEnvelope", "entryTimestamp", "exitSignatureEnvelope", "exitTimestamp", "firstNameSnapshot", "id", "lastNameSnapshot", "legalIdSnapshot", "middleNameSnapshot", "phoneNumber", "secondLastNameSnapshot", "siteId", "vehicleAccessLogId", "visitReason", "withVehicle") SELECT "companyNameSnapshot", "createdById", "entrySignatureEnvelope", "entryTimestamp", "exitSignatureEnvelope", "exitTimestamp", "firstNameSnapshot", "id", "lastNameSnapshot", "legalIdSnapshot", "middleNameSnapshot", "phoneNumber", "secondLastNameSnapshot", "siteId", "vehicleAccessLogId", "visitReason", "withVehicle" FROM "AccessLog";

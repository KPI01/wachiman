/*
  ...
  - You are about to drop the column `entryEnvelope` on the `AccessLog` table. All the data in the column will be lost.
  - You are about to drop the column `exitEnvelope` on the `AccessLog` table. All the data in the column will be lost.
  - Added the required column `entrySignatureEnvelope` to the `AccessLog` table without a default value. This is not possible if the table is not empty.
  - Added the required column `exitSignatureEnvelope` to the `AccessLog` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_AccessLog" (
    ...
    "exitSignatureEnvelope" JSONB NOT NULL,

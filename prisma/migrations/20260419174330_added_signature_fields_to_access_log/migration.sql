/*
  ...
  - Added the required column `entrySignature` to the `AccessLog` table without a default value. This is not possible if the table is not empty.
  - Added the required column `exitSignature` to the `AccessLog` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_AccessLog" (
    ...
    "entrySignature" JSONB NOT NULL,
    "exitTimestamp" DATETIME,
    "exitSignature" JSONB NOT NULL,

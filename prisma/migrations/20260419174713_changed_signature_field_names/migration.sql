/*
  ...
  - You are about to drop the column `entrySignature` on the `AccessLog` table. All the data in the column will be lost.
  - You are about to drop the column `exitSignature` on the `AccessLog` table. All the data in the column will be lost.
  - Added the required column `entryEnvelope` to the `AccessLog` table without a default value. This is not possible if the table is not empty.
  - Added the required column `exitEnvelope` to the `AccessLog` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_AccessLog" (
    ...
    "entryEnvelope" JSONB NOT NULL,
    "exitTimestamp" DATETIME,
    "exitEnvelope" JSONB NOT NULL,
...
INSERT INTO "new_AccessLog" ("companyNameSnapshot", "createdById", "entryTimestamp", "exitTimestamp", "firstNameSnapshot", "id", "lastNameSnapshot", "legalIdSnapshot", "middleNameSnapshot", "phoneNumber", "secondLastNameSnapshot", "siteId", "vehicleAccessLogId", "visitReason", "withVehicle") SELECT "companyNameSnapshot", "createdById", "entryTimestamp", "exitTimestamp", "firstNameSnapshot", "id", "lastNameSnapshot", "legalIdSnapshot", "middleNameSnapshot", "phoneNumber", "secondLastNameSnapshot", "siteId", "vehicleAccessLogId", "visitReason", "withVehicle" FROM "AccessLog";

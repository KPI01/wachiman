...
const EXTERNAL_WORKERS_DATA = [
  { firstName: "Ricardo", lastName: "Fuentes", companyIdx: 1, categoryIdx: 0 },
  { firstName: "Luis", lastName: "Carrasco", companyIdx: 1, categoryIdx: 0 },
  { firstName: "Héctor", lastName: "Vargas", companyIdx: 1, categoryIdx: 0 },
  { firstName: "Manuel", lastName: "Paredes", companyIdx: 2, categoryIdx: 1 },
  { firstName: "Felipe", lastName: "Ortiz", companyIdx: 2, categoryIdx: 1 },
  { firstName: "Óscar", lastName: "Rojas", companyIdx: 2, categoryIdx: 1 },
  { firstName: "Patricio", lastName: "Muñoz", companyIdx: 3, categoryIdx: 2 },
  { firstName: "Alejandro", lastName: "Castillo", companyIdx: 3, categoryIdx: 2 },
  { firstName: "Mariana", lastName: "Vera", companyIdx: 4, categoryIdx: 3 },
  { firstName: "Gloria", lastName: "Reyes", companyIdx: 4, categoryIdx: 3 },
  { firstName: "Sandra", lastName: "Flores", companyIdx: 4, categoryIdx: 3 },
  { firstName: "Roberto", lastName: "Silva", companyIdx: 5, categoryIdx: 4 },
  { firstName: "Cristian", lastName: "Herrera", companyIdx: 5, categoryIdx: 4 },
  { firstName: "Jorge", lastName: "Campos", companyIdx: 5, categoryIdx: 4 },
  { firstName: "Víctor", lastName: "Peña", companyIdx: 6, categoryIdx: 5 },
  { firstName: "Cecilia", lastName: "Cruz", companyIdx: 6, categoryIdx: 5 },
  { firstName: "Natalia", lastName: "León", companyIdx: 1, categoryIdx: 0 },
  { firstName: "Eduardo", lastName: "Morales", companyIdx: 2, categoryIdx: 1 },
] as const;
